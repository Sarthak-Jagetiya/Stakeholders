...
export default function ScholarshipForm() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://10.0.2.128:3000/api/scholarship/${idParam}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiEndpoint = idParam
        ? `http://10.0.2.128:3000/api/scholarship/${idParam}`
        : 'http://10.0.2.128:3000/api/scholarship';
