...
export default function FeeStructureForm() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://15.206.123.134:3000/api/feestructure/${code}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const apiEndpoint = code
        ? `http://15.206.123.134:3000/api/feestructure/${code}`
        : 'http://15.206.123.134:3000/api/feestructure';
