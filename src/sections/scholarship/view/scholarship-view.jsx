...
export default function ScholarshipForm() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://15.206.123.134:3000/api/scholarship/${idParam}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiEndpoint = idParam
        ? `http://15.206.123.134:3000/api/scholarship/${idParam}`
        : 'http://15.206.123.134:3000/api/scholarship';
