        ...
        .then(blob => {
            ...
            reader.onloadend = function() {
                ...
                img.onload = function() {
                    ...
                    doc.text(`Date: ${formattedDate}`, pageWidth- rightMargin, dateHeight,{align:'right'});
                    ...
                    for (let i = 0; i < lines.length; i++) {
                        ...
                        if (currentLine.includes(name)) {
                            ...
                            doc.setFont("times","normal");
                            doc.text(parts[1], leftMargin + doc.getTextWidth(parts[0] + name)+14, y, { align: 'left' });
                        }
                            ...
                            doc.setFont("times","normal");
                            doc.text(parts[1], leftMargin + doc.getTextWidth(parts[0] + date)+5, y, { align: 'left' });
                        }
                        else {
