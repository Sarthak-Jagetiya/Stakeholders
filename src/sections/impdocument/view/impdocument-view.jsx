...
const ImpDocumentForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://15.206.123.134:3000/api/impdocument/${didParam}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const apiEndpoint = didParam
        ? `http://15.206.123.134:3000/api/impdocument/${didParam}`
        : 'http://15.206.123.134:3000/api/impdocument/';
