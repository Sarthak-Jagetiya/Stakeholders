...
export default function ScholarshipForm() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://13.126.201.24:3000/api/scholarship/${idParam}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiEndpoint = idParam
        ? `http://13.126.201.24:3000/api/scholarship/${idParam}`
        : 'http://13.126.201.24:3000/api/scholarship';
