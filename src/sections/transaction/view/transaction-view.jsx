...
export default function TransactionForm() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://13.126.201.24:3000/api/transaction/${idParam}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiEndpoint = idParam
        ? `http://13.126.201.24:3000/api/transaction/${idParam}`
        : 'http://13.126.201.24:3000/api/transaction';
