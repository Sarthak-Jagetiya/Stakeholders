...
export default function TransactionForm() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://15.206.123.134:3000/api/transaction/${idParam}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiEndpoint = idParam
        ? `http://15.206.123.134:3000/api/transaction/${idParam}`
        : 'http://15.206.123.134:3000/api/transaction';
